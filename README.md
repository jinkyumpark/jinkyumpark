<p align="center">
  🙋‍♂️ 안녕하세요!
  <br/><br/>
  웹 표준을 준수하면서 재사용성이 높은 아름다운 코드를 쓰기 위해 항상 공부하는 백엔드 개발자, <b>박진겸</b>입니다
  <br/>
...
| ------------------------- | ------------------------- | ------------------------- | ------------------------- | ------------------------- | ------------------------- |
| 부업 종합 커뮤니티 | 없음 | Spring Boot, JPA  | 1인 | TDD | [Income](http://income.jinkyumpark.com) |
| Springfeed, 인스타그램 기반 SNS | React.js, Bootstrap | Spring Boot, Oracle DB(PL/SQL), JSP | 3인 | 없음 | [Springfeed](http://springfeed.jinkyumpark.com) |
