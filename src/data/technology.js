...
export const technologies = {
	...
	front: [
		...
		},
		{
			...
			name: 'Bootstrap',
			category: 'front',
			features: ['bootstrap의 다양한 component들을 활용해 UI 구성', '반응형 UI 디자인', 'react-bootstrap 활용해 component화'],
			featured: true,
			blogUrl: '',
			resumeFeatured: false,
		},
	...
	back: [
		{
			...
			featured: true,
			blogUrl: 'https://jinkpark.tistory.com/category/프로그래밍/Spring%20Boot',
			resumeFeatured: true,
		},
		...
		},
		{
			...
			featured: true,
			blogUrl: 'https://jinkpark.tistory.com/category/프로그래밍/Spring%20Security',
			resumeFeatured: true,
		},
		{
			id: 5,
			...
			name: 'Spring Cloud',
			category: 'back',
			features: ['BFF 등의 Architecture 패턴의 장단점, 특징을 잘 알고 있고 적재적소에 활용 가능'],
			featured: true,
			blogUrl: 'https://jinkpark.tistory.com/category/프로그래밍/Spring%20Cloud',
			resumeFeatured: true,
		},
		{
			id: 8,
			...
			name: 'Java Testing',
			category: 'back',
			features: ['JUnit의 다양한 기능을 활용한 Unit Testing 작성', 'Mockito로 의존성 없는 Unit Test', 'Integration Test'],
			featured: true,
	...
	devops: [
		...
		},
		{
			...
			name: 'Git',
			category: 'devops',
			features: ['Gitflow Branch 전략을 사용해 Branch 관리', '다양한 git command의 특성을 알고 활용'],
			featured: false,
			blogUrl: '',
			resumeFeatured: false,
		},
